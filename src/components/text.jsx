...
export const Text = (props) => {
  return (
    ...
    <div class="text-page__header">
        <div class="text-page__links-item">
            <a class="post__tag back-link">Вернуться назад</a>
            <a class="post__tag share-link">Поделится
            <use>
        ...
        <h2 class="text-page__title">{props.textArr.title}</h2>
        <time class="post__time">{props.textArr.date}</time>
        <a class="post__tag">{props.textArr.tag}</a>
    </div>
    <div class="post-body">
      <p class="post__text"> {props.textArr.text}</p>
        <img src={props.textArr.imgUrl} alt="post-img" class="post__img"/>
        <p class="post__text">{props.textArr.text}</p>
    </div>
   <Discussion/>
</div>
